...
export default function PosUI({ onAdminSettings, onSearch }) {
  ...
  return (
    <div
      className="h-screen w-full bg-slate-100 p-4 font-sans flex gap-4 overflow-hidden items-stretch"
            ...
            <div className="flex-1 p-8 bg-white overflow-y-auto">
              ...
              {activeTab === "discount" && (
                <div>
                  ...
                  {discountSubTab === "bill" && (
                    <div className="max-w-sm">
                      ...
                      <p className="text-sm text-slate-400 mt-2">
                        * คำนวณจากยอดหลังหักโปรโมชั่นแล้ว
                      </p>
                    </div>
                  )}
                  ...
                  {discountSubTab === "items" && (
                    <div>
                      <h3 className="text-slate-500 font-bold mb-4 text-sm">
                        เลือกสินค้าที่ต้องการลดราคา (Check items to enable
                            ...
                            >
                              <div
                                className={cn(
                                  ...
                                  isChecked
                                    ? "bg-boots-base border-boots-base text-white"
                ...
                <div>
                  ...
                  <div className="mt-8">
                    <h4 className="font-bold text-slate-700 mb-4">
                      คูปองที่ใช้ไป ({coupons.length})
                    </h4>
                    {coupons.length === 0 ? (
                      <p className="text-slate-400">ยังไม่มีคูปอง</p>
                    ) : (
        ...
        >
          <div className="flex justify-between items-center mb-2">
            ...
            >
              {isVoidMode ? (
                <>
                  <MinusCircle size={16} /> VOID MODE (สแกนเพื่อลบ)
                </>
              ) : (
                <>
            ...
            <button
              onClick={() => {
                ...
                if (canFocusScanInput) inputRef.current?.focus();
              }}
              className={cn(
          ...
          <div className="relative group">
            ...
            <input
              ...
              placeholder={
                isVoidMode
                  ? "สแกนสินค้าเพื่อลบออก..."
                  : "สแกนบาร์โค้ด... (พิมพ์ 3* เพื่อระบุจำนวน)"
              }
              autoComplete="off"
              className={cn(
                ...
                {suggestions.map((item, idx) => (
                  <div
                    ...
                    onClick={async () => {
                      ...
                      await handleSelectSuggestion(item.sku);
                    }}
                    className={cn(
        ...
        >
          ...
          {lastItemDetail ? (
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-slate-300">
              ...
              <p className="text-lg font-medium">พร้อมใช้งาน</p>
            </div>
          )}
        </div>
      </div>
        ...
        <div className="px-6 py-4 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className={cn(
                "flex items-center gap-2 px-3 py-1.5 bg-orange-600 hover:bg-orange-500 text-white rounded-lg font-bold text-sm shadow-sm transition-all",
                btnEffect,
              )}
            >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-2">
          {cartItems.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-slate-300">
              ...
              <p className="text-xl font-medium">ตะกร้าว่างเปล่า</p>
            </div>
          ) : (
            cartItems.map((item, index) => {
              ...
              const isItemChecked = discountCheckedItems.has(
                item.id || item.sku,
              );
