        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">
              Find items by name, barcode, or SKU ID
            </p>
          </div>
        </div>
          ...
          {selectedItem ? (
            <div className="h-full flex flex-col p-6 md:p-8 overflow-y-auto">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    {selectedItem.ProductStatus === "Active" ? (
                      <span className="px-2 py-0.5 rounded-full bg-green-500/10 text-green-600 dark:text-green-400 text-[10px] font-bold uppercase tracking-wide border border-green-500/20">
                        Active
                      </span>
                    ) : (
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold leading-tight">
                    {selectedItem.ProductDesc || selectedItem.name}
                  </h2>
                </div>

                <div className="text-right">
                  <div className="text-sm text-slate-500 dark:text-slate-400 uppercase font-bold tracking-wider mb-1">
                    Price
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                ...
                <InfoCard
                  icon={Layers}
                  label="Department"
                  value={selectedItem.DeptDesc || selectedItem.dept}
                />
            ...
            <div className="h-full flex flex-col items-center justify-center text-slate-400 opacity-60">
              ...
              <p className="max-w-xs text-center mt-2">
                Choose an item from the list to view detailed specifications and
                pricing.
              </p>
            </div>
          )}
