    ...
    <div className="h-full p-6 md:p-8 animate-fade-in-up flex flex-col gap-6">
      ...
      <div className="glass-panel p-2 flex items-center gap-2">
        <div className="relative flex-1">
          ...
          />
          <input
            className="w-full pl-10 pr-4 py-2.5 bg-transparent outline-none text-slate-700 dark:text-slate-200 placeholder-slate-400"
        ...
        <div className="flex-1 flex flex-col items-center justify-center p-12 text-slate-400 gap-4 opacity-60">
          ...
          <div className="text-center">
            ...
            <p className="max-w-xs mt-1 text-sm">
              Upload your product catalog in Admin Settings to populate
              inventory.
            </p>
          </div>
        </div>
