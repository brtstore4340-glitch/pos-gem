  ...
  return (
    <div className={cn(
      ...
      <div className={cn("flex-1 flex flex-col m-4 ml-2 rounded-3xl overflow-hidden shadow-xl border relative min-h-0",
         ...
         <div className="flex-1 overflow-y-auto px-4 py-2 scrollbar-hide">
            {cartItems.length === 0 ? (
                ...
                cartItems.map((item, index) => {
                    // Calculate line total (after all promotions)
                    const lineTotal = item.calculatedTotal !== undefined ? item.calculatedTotal : (item.price * item.qty);
                    
                    // Calculate discount: normalPrice is already (qty * unitPrice) from promotion engine
         ...
         {/* FOOTER */}
         <div className="text-white px-5 py-[14px] shrink-0 relative overflow-hidden bg-[#021774]/70 backdrop-blur-md border-t border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.25)]">
             ...
             <div className="relative z-10">
               <div className="flex justify-between items-center mb-4">
                   <div className="flex flex-col">
                       ...
                       <div className="flex items-baseline gap-2">
                          <span className="text-5xl font-bold tracking-tight">{summary?.totalItems || 0}</span>
               ...
               <div className="pt-4 border-t border-white/10 flex items-center justify-between">
                   ...
                   <button 
                      ...
                      className={cn(
                          "px-6 py-3 rounded-xl font-bold text-sm flex items-center gap-2 transition-all leading-normal shadow-lg shadow-black/20 -translate-y-[1px] transform-gpu border-0",
                          "bg-white/10 text-white hover:bg-white/20 active:translate-y-0 active:scale-[0.98] active:bg-[#050D2B]/70 active:backdrop-blur-md active:shadow-[inset_0_1px_0_rgba(255,255,255,0.35)]"
                      )}
                   >
                      <Tag size={18} />
                      <span>ส่วนลด</span>
