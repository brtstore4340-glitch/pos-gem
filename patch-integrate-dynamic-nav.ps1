...
New-Item -ItemType Directory -Path ".\ai-backups" -Force | Out-Null
...
Write-Info "DONE."
'@ | Set-Content -Path ".\scripts\powershell\patch-integrate-dynamic-nav.ps1" -Encoding UTF8
# End of patch-integrate-dynamic-nav.ps1